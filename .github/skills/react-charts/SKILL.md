...
> [!WARNING]\n> This library is listed under deprecated TanStack libraries. Prefer actively maintained alternatives for new work.

## Domain Focus

Use this skill when working with React Charts (TanStack, Deprecated), including:
...
- Does code follow the current official docs for React Charts (TanStack, Deprecated)?
